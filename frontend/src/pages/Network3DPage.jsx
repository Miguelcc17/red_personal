...
const Network3DPage = () => {
  ...
  if (loading) return (
    <div className="flex bg-slate-950 min-h-screen"><Navbar /><div className="flex-1 ml-72 flex items-center justify-center"><Loader /></div></div>
  );
    ...
    <div className="flex bg-slate-950 min-h-screen overflow-hidden">
      ...
      <main className="flex-1 ml-72 relative flex flex-col h-screen">
        <div className="absolute top-8 left-8 z-30 pointer-events-none">
           <div className="flex items-center space-x-3 bg-slate-900/60 backdrop-blur-2xl px-6 py-3 rounded-2xl border border-slate-800 shadow-2xl">
